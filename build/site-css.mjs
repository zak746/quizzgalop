...
.quiz-ref-stage{min-height:0;height:auto;border:1px solid #d3b17a;border-radius:24px;display:grid;grid-template-columns:minmax(330px,430px) minmax(580px,760px) minmax(245px,292px);justify-content:space-between;align-items:start;gap:28px;padding:46px 52px 44px 48px;overflow:hidden}
...
.quiz-ref-center{min-width:0;align-self:start;display:flex;flex-direction:column;justify-content:flex-start}
.quiz-ref-card{border-radius:22px;min-height:560px;padding:28px 44px 22px;display:flex;flex-direction:column}
...
@media (max-width:1160px){
  ...
  .quiz-ref-stage{grid-template-columns:minmax(540px,720px) 260px;justify-content:center}.quiz-ref-left{display:none}.quiz-ref-background{min-height:0}.quiz-ref-session>.quiz-ref-panel{padding-left:16px;padding-right:16px}
...
.quiz-mobile-context{display:none;align-items:center;gap:12px;margin:0 0 10px;padding:9px 12px;border:1px solid #d8bf99;border-radius:12px;background:rgba(255,250,243,.92);box-shadow:0 7px 18px rgba(74,48,20,.06)}
.quiz-mobile-context>a{display:grid;place-items:center;flex:0 0 auto;width:42px;height:42px;border:1px solid #c69a5b;border-radius:50%;color:#174d3b;font:600 23px var(--serif)}.quiz-mobile-context>a:hover{text-decoration:none;background:#f4eadb}.quiz-mobile-context>span{min-width:0;display:flex;flex-direction:column}.quiz-mobile-context small{font-size:9px;letter-spacing:.2em;color:#8d5923}.quiz-mobile-context strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font:600 18px var(--serif);color:#211a14}
