...
.footer-luxury::before,.footer-luxury::after{content:'';position:absolute;width:280px;height:500px;background:url('/assets/maquette-feuillage.webp') center/contain no-repeat;opacity:.35;pointer-events:none}.footer-luxury::before{right:-30px;top:80px;transform:scaleX(-1) rotate(8deg)}.footer-luxury::after{left:-80px;bottom:30px;transform:rotate(-32deg)}
...
body:not(.home-reference):not(.page-quiz-reference) main.site::after{content:'';position:absolute;z-index:0;right:-95px;top:100px;width:260px;height:430px;background:url('/assets/maquette-feuillage.webp') center/contain no-repeat;opacity:.09;pointer-events:none}
...
.editorial-hero::before{content:'';position:absolute;z-index:-1;right:-12px;bottom:-118px;width:310px;height:370px;background:url('/assets/maquette-feuillage.webp') center/contain no-repeat;opacity:.22;transform:rotate(15deg)}
...
.page-fiche-reference .fiche-hero::after{content:'';position:absolute;right:-45px;bottom:-130px;width:330px;height:400px;background:url('/assets/maquette-feuillage.webp') center/contain no-repeat;opacity:.15;pointer-events:none}.page-fiche-reference .fiche-hero>*{position:relative;z-index:1}
